...
ECHO ATTENTION ! CE SCRIPT UTILISANT DES OUTILS 100% SPATIALITE N'EST PAS OPERATIONNEL NI MAINTENU, IL N'EST FOURNI QU'A TITRE D'EXEMPLE. 
ECHO UTILISEZ LES SCRIPTS OGR2GR. 
