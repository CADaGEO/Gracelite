...
REM Gracelite/config.bat
REM Version : 0.01
REM ALENO
REM CONFIGURATION GRACELITE
...
REM ogr2ogr -append .\dbinteg\gracelite_integ.sqlite .\shpcsv-in\t_adresse.shp -nln t_adresse
...
IF EXIST "%GLFILE%" "%GLOGR2OGR%" -append %GLDBINTEG% "%GLFILE%" -nln %GLTBL%
...
SET GLFILE=%GLSHPINPATH%\%GLTBL%.shp
ECHO GRACELITE - INSERT %GLFILE%
IF EXIST "%GLFILE%" "%GLOGR2OGR%" -append %GLDBINTEG% "%GLFILE%" -nln %GLTBL% -nlt PROMOTE_TO_MULTI
